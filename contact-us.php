...
<body>
    ...
    <section id="contact-info">
        <div class="center">                
            ...
            <p class="lead">We're here , stay connected with us!</p>
        </div>
        <div class="gmap-area">
            <div class="container">
                <div class="row">
  ...
  <section id="contact-page">
        <div class="container">
            <div class="center">        
                ...
                <p class="lead">Something urgent?</p> 
            </div> 
            <div class="row contact-wrap"> 
                <div class="status alert alert-success" style="display: none"></div>
                <form  class="contact-form" name="contact-form" method="post"  action="post.php">
...
<!-- <section id="contact-page">
                 ...
                 <div class="row contact-wrap"> 
                        ...
                        <div class="col-sm-5 col-sm-offset-1">
                                ...
                                <div class="form-group"><label>phone*</label>
                                            <input type="number" name="no" class="form-control" required="required">
                                </div>
                              <div class="form-group"><label>Company name*</label>
                                ...
                                <div class="form-group"><label>Message *</label>
                                            <textarea type="text" name="message" class="form-control" required="required"></textarea>
                                </div>
                                <div class="form-group">
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2017<a target="_blank" href="http://shapebootstrap.net/" title="#">V2Lancers</a>. All Rights Reserved.
                </div>
                <div class="col-sm-6">
                    <ul class="pull-right">
                        <li><a href="#">Home</a></li>
